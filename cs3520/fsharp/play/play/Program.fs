...
type Game() =
    //summary: Creates a 800x600 window with the specified title.
    inherit GameWindow(800, 600, GraphicsMode.Default, "F#")
    ...
    //summary: Called when your window is resized. Set your viewport here. 
    //It is also a good place to set up your projection matrix (which probably changes
    ...
    //summary: Called when it is time to setup the next frame. Add your game logic here.
    //<param name="e">Contains timing information for framerate independent logic.</param>
    override o.OnUpdateFrame e =
        base.OnUpdateFrame e
        if base.Keyboard.[Key.Escape] then base.Close()

    //summary: Called when it is time to render the next frame. Add your rendering code here.
