// TowersOfHanoi.cpp : Defines the class behaviors for the application.
...
// CTowersOfHanoiApp
BEGIN_MESSAGE_MAP(CTowersOfHanoiApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

CTowersOfHanoiApp::CTowersOfHanoiApp() // CTowersOfHanoiApp construction
{
...
CTowersOfHanoiApp theApp; // The one and only CTowersOfHanoiApp object

BOOL CTowersOfHanoiApp::InitInstance() // CTowersOfHanoiApp initialization
{
	// InitCommonControlsEx() is required on Windows XP if an application manifest specifies use of ComCtl32.dll version 6 or 
	...
	// you should remove from the following the specific initialization routines you do not need Change the registry key under which our settings are stored
