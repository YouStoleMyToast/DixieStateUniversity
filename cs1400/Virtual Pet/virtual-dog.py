...
def main():
    ...
    while True:
        ...
        elif inBox(rec5, mouseClick):
            drawHungry(win)                           # draw hungry dog
        elif inBox(rec6, mouseClick):
            drawDead(win)                             # draw dead dog
            break                                     # dog is dead stop loop
...
def draw_buttons(win):
    ...
    rec1 = drawRec(win, Point(10,450), Point(100,490), 'green', 'Happy')
    rec2 = drawRec(win, Point(110,450), Point(200,490), 'green', 'Angry')
    rec3 = drawRec(win, Point(210,450), Point(300,490), 'green', 'Sleeping')
    rec4 = drawRec(win, Point(310,450), Point(400,490), 'green', 'Bored')
    rec5 = drawRec(win, Point(410,450), Point(500,490), 'green', 'Hungry')
    rec6 = drawRec(win, Point(510,450), Point(600,490), 'green', 'Dead')
...
# deaddog
# dogleg right
    poly=Polygon (Point (190, 245), Point(280, 245), Point (290, 255), Point(190, 255))
    poly.setFill('darkslategray')
    poly.draw(win)
    oval=Oval(Point(180,245),Point(200,255))
    oval.setFill('darkslategray')
    oval.draw(win)
...
# dogear
    ...
    poly1.draw(win)
# dogleg left
    poly=Polygon (Point (280, 400), Point(305, 320), Point(380, 300), Point (380, 380), Point(310, 350), Point(295, 400))
    poly.setFill('darkslategray')
    poly.draw(win)
    oval=Oval(Point(180,260),Point(200,270))
    oval.setFill('darkslategray')
    oval.draw(win)
    poly=Polygon (Point (190, 260), Point (230, 260), Point(280, 230), Point (280, 265), Point(190, 270))
    poly.setFill('darkslategray')
    poly.draw(win)
