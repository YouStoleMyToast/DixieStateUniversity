    ...
    def letcode(self,token):
        ...
        while ";"not in line[1]:
            ...
            if line[1]==';':
                ...
                print >> self.fout,'poppath 1 popcount',self.popcount
                print >> self.fout,"push constant",intcheck1[1]
                ...
                print 'popcount',self.popcount
                print >> self.fout,'poppath 2 popcount',self.popcount
                print >> self.fout,"push constant",intcheck2[1]
                print >> self.fout,"pop this",self.popcount
                #print >> self.fout,"push pointer 0"
                if intcheck1[0]!=';' or intcheck2[0]!=';' or intcheck3[0]!=';':
                    lineended=True
                ...
                print 'popcount',self.popcount
                print >> self.fout,'poppath 3 popcount',self.popcount
                ...
                print 'popcount',self.popcount
                print >> self.fout,'poppath 4 popcount',self.popcount
...
def main():
    #fin = open(sys.argv[1])
    fin = open("finalprep.jack","r")
    fout = open("finalprep.txt","w")
    tokenlist=[]
    filelist = ''
    ...
    #foutxml.close()
    #generating assembly
    finasembly=open("finalprep.vm","w")
